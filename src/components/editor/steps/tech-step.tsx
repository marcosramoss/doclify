...
export function TechStep({ onNext, onBack }: TechStepProps) {
  ...
  const addCommonTech = (category: string, techName: string) => {
    const exists = watchedTechnologies.some(
      tech =>
    ...
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-gray-600'>
          Documente as tecnologias, frameworks e ferramentas utilizadas no
          projeto.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          {Object.entries(categoryLabels).map(([category, label]) => {
            ...
            const commonTechs =
              commonTechnologies[category as keyof typeof commonTechnologies];
                  ...
                  <CardContent className='space-y-4'>
                    ...
                    <div className='space-y-3'>
                      {fields.map((field, index) => {
                        if (watchedTechnologies[index]?.category !== category)
                          return null;
                        ...
                        return (
                          <Card key={field.id} className='p-4 bg-gray-50'>
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                              ...
                              <div className='flex items-end space-x-2'>
                                <div className='flex-1'>
                                  <Label
                                    htmlFor={`technologies.${index}.version`}
                                  >
                                    Versão
                                  </Label>
                                  <Input
                            ...
                            <div className='mt-3'>
                              <Label
                                htmlFor={`technologies.${index}.description`}
                              >
                                Descrição/Uso
                              </Label>
                              <Textarea
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Descreva a arquitetura geral do sistema, padrões utilizados e
        ...
        <div className='flex justify-between pt-6'>
          ...
          <div className='flex space-x-2'>
            ...
            <Button type='submit'>Próximo: Objetivos</Button>
          </div>
        </div>
      </form>
