        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Formulário multi-step com validação para capturar todos os
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Gerencie stakeholders, equipe e responsabilidades de forma
                organizada
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Exporte seus documentos em PDF com layout profissional e
                personalizado
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Formulários com validação em tempo real para garantir qualidade
                dos dados
              </CardDescription>
            </CardHeader>
          </Card>
      ...
      <section className='bg-blue-600 text-white py-20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl mb-8 opacity-90'>
            Crie sua conta gratuita e comece a gerar documentos profissionais
            hoje mesmo.
          </p>
          <Link href='/auth/register'>
